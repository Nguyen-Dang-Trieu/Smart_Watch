...
### STM32
Keil C
- B1: Mở phần mềm Keil C, và mở thư mục `cor1_stm`.
- B2: Copy những driver cần thiết.
- B3: Build và nạp vào STM32.
  
### ESP32
VS-code và ESP-IDF
- B1: Mở vs-code, mở thư mục `core2_esp`.
- B2: Copy những driver cần thiết.
- B3: Build và nạp vào ESP32.
